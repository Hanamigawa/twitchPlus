...
class App extends React.Component {
    ...
    return(
        <Layout>
            <Header>
                <Row justify="space-between"> {/*加了space-between Login Register两个按钮会到右边*/}
                    <Col>
                        {
                            this.state.loggedIn &&
            ...
            <Layout>
                <Sider width = {300} className = 'site-layout-background'>
                    ...
                    >
                        ...
                        <SubMenu icon={<FireOutlined />} key="Popular Games"
                                 title="Popular Games" className="site-top-game-list"
                        >
                            {
